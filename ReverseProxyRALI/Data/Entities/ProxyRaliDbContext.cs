...
public partial class ProxyRaliDbContext : DbContext
{
    ...
    public virtual DbSet<ProxyConfiguration> ProxyConfigurations { get; set; }

    public virtual DbSet<RateLimitRule> RateLimitRules { get; set; }
    public virtual DbSet<WafRule> WafRules { get; set; }
    public virtual DbSet<EndpointGroupWafRule> EndpointGroupWafRules { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EndpointGroup>(entity =>
        {
            ...
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getutcdate())");
            entity.Property(e => e.UpdatedAt).HasDefaultValueSql("(getutcdate())");
            entity.HasOne(d => d.RateLimitRule)
                  .WithMany(p => p.EndpointGroups)
                  .HasForeignKey(d => d.RateLimitRuleId)
                  .OnDelete(DeleteBehavior.SetNull) // <-- Asegura consistencia con el SQL
                  .HasConstraintName("FK_EndpointGroups_RateLimitRules");
        });
        ...
        modelBuilder.Entity<ProxyConfiguration>(entity =>
        {
        ...
        modelBuilder.Entity<WafRule>(entity =>
        {
            entity.Property(e => e.CreatedAt).HasDefaultValueSql("(getutcdate())");
        });

        modelBuilder.Entity<EndpointGroupWafRule>(entity =>
        {
            // Define la clave primaria compuesta
            entity.HasKey(e => new { e.EndpointGroupId, e.WafRuleId });

            // Configura la relación con EndpointGroup
            entity.HasOne(e => e.EndpointGroup)
                  .WithMany(g => g.EndpointGroupWafRules)
                  .HasForeignKey(e => e.EndpointGroupId);

            // Configura la relación con WafRule
            entity.HasOne(e => e.WafRule)
                  .WithMany(r => r.EndpointGroupWafRules)
                  .HasForeignKey(e => e.WafRuleId);
        });
